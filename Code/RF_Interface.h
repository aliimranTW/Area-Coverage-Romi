 ...
 *  WE NEED TO UPDATE THESE VALUES FOR THE RFID TAGS SCANNED SO THAT WE KNOW WHERE TO GO
 */
#define NUM_CARDS 3
...
void setupRFID()//called from main function
{
...
float serialToXPos(char * serNum)//searches array for position
{
