...
const float WHEEL_DISTANCE = 139;
const float COUNTS_PER_WHEEL_REVOLUTION = 1440;//GEAR_RATIO * COUNTS_PER_SHAFT_REVOLUTION;
const float MM_PER_COUNT = 0.15; //( 2 * WHEEL_RADIUS * PI ) / COUNTS_PER_WHEEL_REVOLUTION;
...
class Kinematics
{
    ...
    private:
         ...
         float x=0;//changed to 0
         float y=0;// changed to 0
         float theta=0;
         float last_theta = 0;
